          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(adminpath.'/page'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> Back </a> </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
			...
			if($home) {?>
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="page_title">On Banner Title</label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                     
                       <input id="bannerhead" class="form-control col-md-7 col-xs-12" name="bannerhead" required="required" type="text" value="<?php echo $bannerhead; ?>">
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">PDF </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
