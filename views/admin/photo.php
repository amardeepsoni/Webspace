                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url(adminpath.'/photo/add'); ?>" class="btn btn-primary btn-xs"> Add </a>
                      <a onclick=" $('#photoform').attr('action', '<?php echo $deleteaction; ?>'); $('#photoform').submit();  " class="btn btn-danger btn-xs"> Delete</a>

                      <a onclick=" $('#photoform').attr('action', '<?php echo $activeaction; ?>'); $('#photoform').submit();  " class="btn btn-warning btn-xs"> Active</a>

                      <a onclick=" $('#photoform').attr('action', '<?php echo $inactiveaction; ?>'); $('#photoform').submit();  " class="btn btn-info btn-xs">Inactive</a>
