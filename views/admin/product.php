                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url(adminpath.'/product/add'); ?>" class="btn btn-primary btn-xs"> Add </a>
                      <a onclick=" $('#productform').attr('action', '<?php echo $deleteaction; ?>'); $('#productform').submit();  " class="btn btn-danger btn-xs"> Delete</a>

                      <a onclick=" $('#productform').attr('action', '<?php echo $activeaction; ?>'); $('#productform').submit();  " class="btn btn-warning btn-xs"> Active</a>

                      <a onclick=" $('#productform').attr('action', '<?php echo $inactiveaction; ?>'); $('#productform').submit();  " class="btn btn-info btn-xs">Inactive</a>
