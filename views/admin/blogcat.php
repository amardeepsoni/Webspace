                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url(adminpath.'/blogcat/add'); ?>" class="btn btn-primary btn-xs"> Add </a>
                      <a onclick=" $('#blogcatform').attr('action', '<?php echo $deleteaction; ?>'); $('#blogcatform').submit();  " class="btn btn-danger btn-xs"> Delete</a>

                      <a onclick=" $('#blogcatform').attr('action', '<?php echo $activeaction; ?>'); $('#blogcatform').submit();  " class="btn btn-warning btn-xs"> Active</a>

                      <a onclick=" $('#blogcatform').attr('action', '<?php echo $inactiveaction; ?>'); $('#blogcatform').submit();  " class="btn btn-info btn-xs">Inactive</a>

                    </div>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <form id="blogcatform" name="blogcatform" method="post">
