          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
			...
			if($home) {?>
                        ...
                        <?php }?>
                            ...
                            <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Select Video </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
			...
			if($vidorimg) {?>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input  class="form-control col-md-7 col-xs-12" name="videos"  type="text" value="<?php echo $videos; ?>">
                    </div>
                  </div>
                  <div class="item form-group">
