          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(adminpath.'/category'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> Back </a> </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" novalidate>
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">flag Icon </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input type='file' name='flagiocn' id="flagiocn" size='20' />
                      <?php echo $flagiocn; ?> </div>
                  </div>
                  <div class="item form-group">
                    <label class="col-xs-12" for="textarea">Home Short Description </label>
                    <div class="col-xs-12">
                      <textarea id="homecontent" required="required" name="homecontent" class="form-control col-md-7 col-xs-12 ckeditor"><?php echo $homecontent; ?></textarea>
                    </div>
                  </div>
                  <div class="item form-group">
