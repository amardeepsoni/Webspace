          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(adminpath.'/projects'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> Back </a> </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
			...
			if($home) {?>
                        ...
                        <?php }?>
                         ...
                         <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Subhead <span class="required">*</span> </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                   ...
                   <div class="item form-group">
                    ...
                    <div class="col-xs-12">
                      <textarea id="shortdescription"  name="shortdescription" class="form-control col-md-7 col-xs-12 ckeditor"><?php echo $shortdescription; ?></textarea>
                    </div>
                  </div>
                    ...
                    <div class="col-xs-12">
                      <textarea id="description"  name="description" class="form-control col-md-7 col-xs-12 ckeditor"><?php echo $description; ?></textarea>
                    </div>
                  </div>
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Icon </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
