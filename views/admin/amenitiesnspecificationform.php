          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
              <div class="x_title">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(adminpath.'/amenitiesnspecification'); ?>" class="btn btn-primary btn-xs"><i class="fa fa-arrow-left"></i> Back </a> </div>
                <div class="clearfix"></div>
              </div>
              <div class="x_content">
                <form class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" novalidate>
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Select Product <span class="required">*</span> </label>
                  ...
                  <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Select Amenities & Features OR 
                      Specification </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <select id="amtorfeatuire" name="amtorfeatuire" class="form-control">
                        <?php
			if($amtorfeatuire) {?>
                        <option value="1" selected="selected">Amenities & Features</option>
                        <option value="0">Specification</option>
                        <?php } else { ?>
                        <option value="1" >Amenities & Features</option>
                  ...
                  <div class="item form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <?php echo $image; ?> </div>
                         ...
                         <div class="item form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Icon <span class="required">*</span> </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                      <input id="iocn" class="form-control col-md-7 col-xs-12" name="iocn" required="required" type="text" value="<?php echo $iocn; ?>">
                    </div>
                  </div>
