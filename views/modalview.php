...
<button type="button" <?php echo $dis ?> style="display:none;" id="myButton" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal">Open Modal</button>
<!-- Modal -->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 style="text-transform:uppercase"><?php echo $popup['heading'] ?></h4>
      </div>
      <div class="modal-body">
        <img id="popupimg" <?php echo $img ?> src=" <?php echo $popup['image'] ?>" />
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-default" onclick="closemodal()">Mark as read</a>
        <a class="btn btn-default" onclick="closemodal()" target="_blank" href="<?php echo $popup['hyperlink'] ?>"><?php echo $popup['action'] ?></a>
      </div>
    </div>
  </div>
</div>
